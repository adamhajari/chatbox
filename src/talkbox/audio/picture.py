"""The screen: a picture of what was asked about, while Talkbox answers (PLAN.md D28).
...
screen that is lit only while Talkbox speaks tells a child, without a word, which of
...
from talkbox.pictures import Picture
...
_POOL = ThreadPoolExecutor(max_workers=1, thread_name_prefix="talkbox-picture")
