"""Input/output adapters (PLAN.md section 7). The core (`talkbox.voice`) sees only an
...
def audio_device_problem(input_device=None, output_device=None) -> str | None:
    ...
    try:
        ...
        return f"the sounddevice package isn't installed ({e}). Reinstall Talkbox: pip install -e ."
