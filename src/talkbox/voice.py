...
adapter (the laptop's in `talkbox.audio`, the Pi's later) hands it the recording as it
...
from talkbox.pipeline import Answer, Pipeline
from talkbox.speech import SpeechToText, TextToSpeech, Transcript

Cue = Literal["listening", "stopped", "cancel", "error"]

_POOL = ThreadPoolExecutor(max_workers=2, thread_name_prefix="talkbox-stt")
