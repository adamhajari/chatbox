        ...
        if button is None:
            ...
            try:
                ...
                raise RuntimeError(
                    ...
                    "in chatbox.toml, that nothing else is using it, and that your user "
        ...
        if led is None:
            ...
            try:
                ...
                raise RuntimeError(
                    ...
                    "Check the pins in chatbox.toml and that your user is in the gpio "
...
def image_size(rotation: int) -> tuple[int, int]:
    ...
    Landscape (90 or 270) is how Chatbox mounts it: a photograph of a thing is usually
...
class Screen:
    ...
    def _open(dc: int, reset: int, cs: int, baudrate: int, rotation: int):
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "list something), the pins in chatbox.toml, and that your user is in the "
    ...
    def _open_backlight(pin: int, active_high: bool):
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "in chatbox.toml, that nothing else is using it, and that your user is in "
    ...
    def show(self, image) -> None:
        if getattr(image, "size", None) != self.size:
            ...
            from chatbox.pictures import fit
